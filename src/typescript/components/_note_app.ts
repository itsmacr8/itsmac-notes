const notesContainer = document.querySelector('[data-note="container"]'),
    addNoteButton = document.querySelector('[data-note="add-button"]'),
    searchForm = document.querySelector('[data-search="form"]'),
    searchInput = document.querySelector('[data-search="input"]') as HTMLInputElement,
    addNoteTitle = document.querySelector('[data-note="title"]') as HTMLInputElement,
    addNoteText = document.querySelector('[data-note="body"]') as HTMLInputElement;
...
function showNotes() {
    ...
    if (saveNotes.length !== 0) {
        saveNotes.forEach(function (note: any, index: string) {
...
notesContainer?.addEventListener('click', function (event: Event) {
